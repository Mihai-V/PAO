...
public class DisplayTablets extends JFrame implements ActionListener {
    ...
    DisplayTablets(){
        ...
        button1.addActionListener(new DisplayTablets.ButtonListener());
    ...
    public void showData(){
        ...
        frame.setTitle("Display Tablets");

        label4 = new JLabel("Displaying Tablets:");
        label4.setForeground(Color.green);
        label4.setFont(new Font("Serif", Font.BOLD, 20));

        label1 = new JLabel("Manufacturer:");
        label2 = new JLabel("Model:");
        label3 = new JLabel("Connection Type:");
        ...
        try{
            ...
            PreparedStatement preparedStatement = connection.prepareStatement("SELECT * from tablet where manufacturer=?");
